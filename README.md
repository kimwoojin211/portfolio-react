...
1. In your terminal of choice, navigate to the desired location on your local machine and run the command `git clone https://github.com/kimwoojin211/portfolio-react` (alternatively, download the zipped folder from the URL and unzip the folder in your desired folder)
